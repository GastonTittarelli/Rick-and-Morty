...
describe('CharactersComponent', () => {
  ...
  it('debería cargar personajes al inicializarse', () => {
    spyOn(rickService, 'getAllCharacters').and.callThrough();
    component.ngOnInit();
    expect(rickService.getAllCharacters).toHaveBeenCalledWith(1, '');
  });

  it('debería actualizar searchTerm y recargar personajes al buscar', () => {
  ...
  it('no debería ejecutar loadCharacters si el término no es string', () => {
    spyOn(component as any, 'loadCharacters');
    component.handleSearch(null as any);
    expect((component as any).loadCharacters).not.toHaveBeenCalled();
  });

  it('debería actualizar la página actual y recargar personajes', () => {
    spyOn(component as any, 'loadCharacters');
  ...
  it('debería manejar correctamente la respuesta exitosa de personajes', () => {
  ...
  it('debería manejar error 404 correctamente', () => {
  ...
  it('debería navegar a la página de detalle del personaje', () => {
    component.goToDetail(1);
    expect(router.navigate).toHaveBeenCalledWith(['/home/characters', 1]);
  });

  it('debería renderizar las tarjetas de personajes', () => {
  ...
  it('debería mostrar mensaje de noResults', () => {
  ...
  it('debería llamar handleSearch cuando app-search emita un término', () => {
  ...
  it('debería llamar handlePageChange cuando app-paginator emita un cambio de página', () => {
